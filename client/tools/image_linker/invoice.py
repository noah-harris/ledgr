...
class Invoice(Modal):
    ...
    def __init__(self, master, image_queue):
        ...
        def _grid_ui_elements():
            ...
            self.invoice_form.grid(row=1, column=0, rowspan=1, columnspan=1, padx=10, pady=(0,10), sticky="w")
            self.invoice_item_table.grid(row=1, column=1, columnspan=2, padx=(0,10), sticky="nsew")
            ttk.Button(self, text="Save", command=lambda: self._save()).grid(row=2, column=0, padx=10, pady=10, sticky="w")
            self.invoice_item_table_controls.grid(row=2, column=1, sticky="w")
            self.invoice_item_table_total.grid(row=2, column=2, sticky="w")
